...
prob_lstm = np.loadtxt('LSTM.out')
prob_lstm_random = np.loadtxt('LSTM_random.out')
...
frac_of_pos_lstm_random, mean_pred_value_lstm_random = calibration_curve(True_logit, prob_lstm_random, n_bins=10)
...
plt.plot(mean_pred_value_lstm, frac_of_pos_lstm,  color='cyan', linestyle='dashed',linewidth=1, label='LSTM')
plt.plot(mean_pred_value_lstm_random, frac_of_pos_lstm_random,  color='gray', linestyle='solid',linewidth=2, label='LSTM_RANDOM')
plt.plot(mean_pred_value_fl_random_time, frac_of_pos_fl_random_time,  color='pink', linestyle='solid',linewidth=2, label='LSTM_RANDOM_TIME')
